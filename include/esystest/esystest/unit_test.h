...
#define ESYSTEST_FIXTURE_TEST_CASE_NO_DECOR(test_name, F)                     \
    ESYSTEST_FIXTURE_TEST_CASE_WITH_DECOR(test_name, F, *::esystest::nil_t()) \
    /**/

#define ESYSTEST_AUTO_TEST_CASE_NO_DECOR(test_name)                   \
    ESYSTEST_FIXTURE_TEST_CASE_NO_DECOR(test_name, ::esystest::nil_t) \
    /**/
...
struct equal_impl_frwd
{
    ...
    inline bool call_impl(Left const &left, Right const &right) const
    {
        return equal_impl(left, right);
    }

    template<typename Left, typename Right>
    inline bool operator()(Left const &left, Right const &right) const
    {
...
#define ESYSTEST_WARN(P) ESYSTEST_TEST_TOOL_IMPL_P(2, (P), "", ::esystest::WARN, ::esystest::CHECK_PRED, _, _)
#define ESYSTEST_CHECK(P) ESYSTEST_TEST_TOOL_IMPL_P(2, (P), "", ::esystest::CHECK, ::esystest::CHECK_PRED, _, _)
#define ESYSTEST_REQUIRE(P) ESYSTEST_TEST_TOOL_IMPL_P(2, (P), "", ::esystest::REQUIRE, ::esystest::CHECK_PRED, _, _)

#define ESYSTEST_WARN_EQUAL(L, R) \
    ESYSTEST_TEST_TOOL_IMPL(0, ::esystest::equal_impl_frwd(), "", ::esystest::WARN, ::esystest::CHECK_EQUAL, (L), (R))
#define ESYSTEST_CHECK_EQUAL(L, R) \
    ESYSTEST_TEST_TOOL_IMPL(0, ::esystest::equal_impl_frwd(), "", ::esystest::CHECK, ::esystest::CHECK_EQUAL, (L), (R))
...
#define ESYSTEST_CHECK_NE(L, R) \
    ESYSTEST_TEST_TOOL_IMPL(0, ::esystest::ne_impl(), "", ::esystest::CHECK, ::esystest::CHECK_NE, (L), (R))
#define ESYSTEST_REQUIRE_NE(L, R) \
    ESYSTEST_TEST_TOOL_IMPL(0, ::esystest::ne_impl(), "", ::esystest::REQUIRE, ::esystest::CHECK_NE, (L), (R))

#define ESYSTEST_WARN_LT(L, R) \
    ESYSTEST_TEST_TOOL_IMPL(0, ::esystest::lt_impl(), "", ::esystest::WARN, ::esystest::CHECK_LT, (L), (R))
#define ESYSTEST_CHECK_LT(L, R) \
    ESYSTEST_TEST_TOOL_IMPL(0, ::esystest::lt_impl(), "", ::esystest::CHECK, ::esystest::CHECK_LT, (L), (R))
#define ESYSTEST_REQUIRE_LT(L, R) \
    ESYSTEST_TEST_TOOL_IMPL(0, ::esystest::lt_impl(), "", ::esystest::REQUIRE, ::esystest::CHECK_LT, (L), (R))

#define ESYSTEST_WARN_LE(L, R) \
    ESYSTEST_TEST_TOOL_IMPL(0, ::esystest::le_impl(), "", ::esystest::WARN, ::esystest::CHECK_LE, (L), (R))
#define ESYSTEST_CHECK_LE(L, R) \
    ESYSTEST_TEST_TOOL_IMPL(0, ::esystest::le_impl(), "", ::esystest::CHECK, ::esystest::CHECK_LE, (L), (R))
#define ESYSTEST_REQUIRE_LE(L, R) \
    ESYSTEST_TEST_TOOL_IMPL(0, ::esystest::le_impl(), "", ::esystest::REQUIRE, ::esystest::CHECK_LE, (L), (R))

#define ESYSTEST_WARN_GT(L, R) \
    ESYSTEST_TEST_TOOL_IMPL(0, ::esystest::gt_impl(), "", ::esystest::WARN, ::esystest::CHECK_GT, (L), (R))
#define ESYSTEST_CHECK_GT(L, R) \
    ESYSTEST_TEST_TOOL_IMPL(0, ::esystest::gt_impl(), "", ::esystest::CHECK, ::esystest::CHECK_GT, (L), (R))
#define ESYSTEST_REQUIRE_GT(L, R) \
    ESYSTEST_TEST_TOOL_IMPL(0, ::esystest::gt_impl(), "", ::esystest::REQUIRE, ::esystest::CHECK_GT, (L), (R))

#define ESYSTEST_WARN_GE(L, R) \
    ESYSTEST_TEST_TOOL_IMPL(0, ::esystest::ge_impl(), "", ::esystest::WARN, ::esystest::CHECK_GE, (L), (R))
#define ESYSTEST_CHECK_GE(L, R) \
    ESYSTEST_TEST_TOOL_IMPL(0, ::esystest::ge_impl(), "", ::esystest::CHECK, ::esystest::CHECK_GE, (L), (R))
#define ESYSTEST_REQUIRE_GE(L, R) \
    ESYSTEST_TEST_TOOL_IMPL(0, ::esystest::ge_impl(), "", ::esystest::REQUIRE, ::esystest::CHECK_GE, (L), (R))
...
#define ESYSTEST_GLOBAL_FIXTURE(F) ::esystest::GlobalFixture_t<F> g_##gf##F /**/
