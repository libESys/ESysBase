...
class GenVersion:
    ...
    def generate(self) -> None:
        ...
        final_output = template.safe_substitute(major=versions[0], minor=versions[1], patch=versions[2])
...
if __name__ == "__main__":
    ...
    gen_version.set_template_file(os.path.abspath(os.path.join(root_path, "src", "esystest", "version_defs.temph")))
    gen_version.set_output_file(os.path.abspath(os.path.join(root_path, "include", "esystest", "version_defs.h")))
